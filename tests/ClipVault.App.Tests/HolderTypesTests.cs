...
{
    [Fact]
    public void PassphraseProvider_exposes_the_supplied_passphrase() => Assert.Equal("secret", new PassphraseProvider("secret").Passphrase);

    [Fact]
    public void PassphraseProvider_allows_null() => Assert.Null(new PassphraseProvider(null).Passphrase);
